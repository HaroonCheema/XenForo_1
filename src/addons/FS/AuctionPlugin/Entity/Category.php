 ...
 * @property \FS\AuctionPlugin\Entity\CategoryWatch[] Watch
 * @property \FS\AuctionPlugin\Entity\CategoryRead[] Read
...
class Category extends AbstractCategoryTree
{
    ...
    protected function _postDelete()
    {
        ...
        {
            $this->app()->jobManager()->enqueueUnique('z61ClassifiedsCategoryDelete.' . $this->category_id, 'FS\AuctionPlugin:CategoryDelete', [
    ...
    public function isPrefixUsable($prefix, \XF\Entity\User $user = null)
    {
        ...
        if (!($prefix instanceof ListingPrefix))
        {
            $prefix = $this->em()->find('FS\AuctionPlugin:ListingPrefix', $prefix);
            if (!$prefix)
            {
                return false;
            }
    ...
    {
        $bidding = $this->_em->create('FS\AuctionPlugin:Bidding');
        $bidding->set('category_id', $this->category_id);
    ...
    public function getPrefixes()
    {
        ...
        $prefixes = $this->finder('FS\AuctionPlugin:ListingPrefix')
    ...
    public function getViewableDescendants()
    {
        ...
        {
            $viewable = $this->repository('FS\AuctionPlugin:Category')->getViewableCategories($this);
    ...
    {
        $typeFinder = $this->finder('FS\AuctionPlugin:ListingType');
    ...
    {
        $conditionFinder = $this->finder('FS\AuctionPlugin:Condition');
        $conditionFinder
    ...
    {
        $packageFinder = $this->finder('FS\AuctionPlugin:Package');
    ...
    public static function getStructure(Structure $structure)
    {
        ...
        $structure->columns = [
            ...
            // ],
            // 'listing_t/ype_ids' => ['type' => self::LIST_COMMA,
        ...
        $structure->relations = [
            ...
            'Watch' => [
                'entity' => 'FS\AuctionPlugin:CategoryWatch',
                'type' => self::TO_MANY,
                'conditions' => 'category_id',
                'key' => 'user_id'
            ],
            'Read' => [
                'entity' => 'FS\AuctionPlugin:CategoryRead',
                'type' => self::TO_MANY,
                'conditions' => 'category_id',
                'key' => 'user_id'
            ],
    ...
    {
        /** @var \FS\AuctionPlugin\XF\Entity\Forum $forum */

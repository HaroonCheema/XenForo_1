...
use FS\AuctionPlugin\Repository\ListingLocation;

class Overview extends AbstractPlugin
{
    public function getCategoryListData(\FS\AuctionPlugin\Entity\Category $category = null)
    {
    ...
    public function getCoreListData(array $sourceCategoryIds, \FS\AuctionPlugin\Entity\Category $category = null, $fetchOptions = [])
    {
    ...
    public function actionFilters(\FS\AuctionPlugin\Entity\Category $category = null)
    {
        $filters = $this->getListingFilterInput();
        ...
        $availablePrefixIds = $this->repository('FS\AuctionPlugin:CategoryPrefix')->getPrefixIdsInContent($applicableCategoryIds);
        $prefixes = $this->repository('FS\AuctionPlugin:ListingPrefix')->findPrefixesForList()
        ...
        return $this->view('FS\AuctionPlugin:Filters', 'z61_classifieds_filters', $viewParams);
    }
    ...
    public function getListingFilterInput()
    {
        ...
        if ($input['address']) {
            ...
            $locationRepo = $this->repository('FS\AuctionPlugin:ListingLocation');
    ...
    /**
     * @return \FS\AuctionPlugin\Repository\Listing
     */
    protected function getListingRepo()
    {
        return $this->repository('FS\AuctionPlugin:Listing');
    }

...
namespace FS\AuctionPlugin\Service;

use XF\Entity\Post;
use XF\Entity\Thread;
use XF\Entity\User;

class AuctionBidPost extends \XF\Service\AbstractService
{
	...
	public $performValidations = true;
	...
	public function setPostDefaults()
	{
	...
	public function setPostPosition(array $threadInfo)
	{
		$post = $this->post;

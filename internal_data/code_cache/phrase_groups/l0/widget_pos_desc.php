...
return array (
  ...
  'widget_pos_desc.classifieds_category_sidenav' => 'Displays inside the side navigation on the classifieds category pages. Widget templates rendered in this position can use the current category entity in the <code>{$context.category}</code> param.',
  'widget_pos_desc.classifieds_listing_view_sidebar' => 'Displays inside the side navigation on the classifieds listing view page.',
  'widget_pos_desc.classifieds_overview_sidenav' => 'Displays inside the side navigation on the classifieds overview page.',

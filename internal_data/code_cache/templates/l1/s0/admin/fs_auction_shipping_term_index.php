<?php
// FROM HASH: fd8c127aa77b3bd423582401410c13f7
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
  ...
  ';
    ...
    ' . $__templater->dataRow(array(
				...
				'_type' => 'cell',
				'html' => ' ' . $__templater->escape($__vars['value']['shipping_term']) . ' ',
			),
			array(
				'href' => $__templater->func('link', array('ship-terms/edit', $__vars['value'], ), false),
				'_type' => 'action',
				'html' => 'Edit',
			),
			array(
				'href' => $__templater->func('link', array('ship-terms/delete', $__vars['value'], ), false),
				'overlay' => 'true',
				'_type' => 'delete',
				'html' => '',
			))) . '
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Add Shipping Terms');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
  ' . $__templater->button('Add Term', array(
		'href' => $__templater->func('link', array('ship-terms/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');

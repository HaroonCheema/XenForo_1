<?php
// FROM HASH: 56426120ad6f9727470102a0494a150d
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
  ...
  ';
    ...
    ' . $__templater->dataRow(array(
				...
				'_type' => 'cell',
				'html' => ' ' . $__templater->escape($__vars['value']['ship_via']) . ' ',
			),
			array(
			...
			array(
				'href' => $__templater->func('link', array('ship-via/delete', $__vars['value'], ), false),
				'overlay' => 'true',
				'_type' => 'delete',
				'html' => '',
			))) . '
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Add Ships Via');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
  ' . $__templater->button('Add Via', array(
		'href' => $__templater->func('link', array('ship-via/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');

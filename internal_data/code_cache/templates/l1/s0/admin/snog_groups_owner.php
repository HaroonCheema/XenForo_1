<?php
// FROM HASH: d12ea1844b1b4df3bef1a12f3e85b16e
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Group owner permissions');
	$__finalCompiled .= '

';
	$__templater->setPageParam('section', 'snogGroups_permissions');
	$__finalCompiled .= '
					...
					foreach ($__vars['permissions'] AS $__vars['permission']) {
						...
						if ($__vars['permission']['interface_group_id'] == $__vars['displayedGroup']) {
							...
							if ($__vars['permission']['permission_type'] == 'flag') {
								$__compilerTemp2 .= '
									';
								$__vars['value'] = $__vars['permission']['owner_value'];
								$__compilerTemp2 .= '
								...
								$__compilerTemp2 .= '
									';
								$__vars['value'] = $__vars['permission']['owner_int'];
								$__compilerTemp2 .= '

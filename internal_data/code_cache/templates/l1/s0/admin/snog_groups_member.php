<?php
// FROM HASH: a5eb7864028e07db217701b2d8bbd9c9
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Group member permissions');
	$__finalCompiled .= '

';
	$__templater->setPageParam('section', 'snogGroups_member');
	$__finalCompiled .= '
	...
	if ($__templater->isTraversable($__vars['permissions'])) {
		foreach ($__vars['permissions'] AS $__vars['interfaceGroup']) {
			...
			if ($__vars['interfaceGroup']['interface_group_id'] !== $__vars['displayedGroup']) {
				...
				$__compilerTemp1 .= '
				';
				if (($__vars['displayedGroup'] !== 'forumModeratorPermissions') AND ($__vars['displayedGroup'] !== 'amediaModeratorPermissions')) {
					$__compilerTemp1 .= '
						...
						foreach ($__vars['permissions'] AS $__vars['permission']) {
							...
							if ($__vars['permission']['interface_group_id'] == $__vars['displayedGroup']) {
								...
								if ($__vars['permission']['permission_type'] == 'flag') {
									$__compilerTemp2 .= '
										';
									$__vars['value'] = $__vars['permission']['member_value'];
									$__compilerTemp2 .= '
									...
									$__compilerTemp2 .= '
										';
									$__vars['value'] = $__vars['permission']['member_int'];
									$__compilerTemp2 .= '

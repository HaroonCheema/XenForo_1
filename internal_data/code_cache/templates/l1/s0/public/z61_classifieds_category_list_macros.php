...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
				...
				';
	if ($__templater->method($__vars['xf']['visitor'], 'canViewAwaitingPayments', array())) {
		$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('classifieds/awaiting-payment', ), true) . '" class="blockLink">' . 'Awaiting payment' . '</a>
				';
	}
	$__finalCompiled .= '
			</div>

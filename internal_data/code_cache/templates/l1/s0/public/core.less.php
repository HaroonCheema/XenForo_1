...
' . $__templater->includeTemplate('core_bssp.less', $__vars) . $__templater->includeTemplate('dbtech_ecommerce_core.less', $__vars) . $__templater->includeTemplate('core_xfrm.less', $__vars);

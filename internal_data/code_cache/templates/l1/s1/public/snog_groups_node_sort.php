<?php
// FROM HASH: 8806e87df2895260d5b577e7f3e84e3b
return array(
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Sort sub-forums');
	$__finalCompiled .= '

' . $__templater->callMacro('nestable_macros', 'setup', array(), $__vars) . '
...
', array(
		'action' => $__templater->func('link', array('group/sortforums', $__vars['group'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	)) . '

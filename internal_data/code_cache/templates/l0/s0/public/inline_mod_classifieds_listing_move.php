<?php
// FROM HASH: cfc7ffb63872b4685dbd442131004fd0
return array(
...
';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Move classifieds listings');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Are you sure you want to move ' . $__templater->escape($__vars['total']) . ' classifieds listings(s)?', array(
		'rowtype' => 'confirm',
	)) . '
		...
		'name' => 'apply_prefix',
		'label' => 'Apply prefix to selected  classifieds listings',
		'_dependent' => array('

<?php
// FROM HASH: a9a919277220779b60d5adde8f62cb87
return array(
 ...
 * (c) 2017 Adam Shaw
 *
 * Modified for use with XF2 Social Groups by Snog
 */
...
.fc-event {
	...
	line-height: 1.3;
	border-radius: 3px;
	border: 1px solid @xf-snog_groupevent; /* default BORDER color */
	font-weight: normal; /* undo jqui\'s ui-widget-header bold */
}

.fc-event,
.fc-event-dot {
	background-color: @xf-snog_groupevent;
}
...
.fc-toolbar:after{
	...
	content: "' . 'Click on event for more information' . '";
}

<?php
// FROM HASH: d6a2c72fd9ca645c665b4da0437e05bd
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Search classifieds listings');
	$__finalCompiled .= '
			...
			foreach ($__vars['prefixGroups'] AS $__vars['groupId'] => $__vars['prefixGroup']) {
				if (($__templater->func('count', array($__vars['prefixesGrouped'][$__vars['groupId']], ), false) > 0)) {
					$__compilerTemp1[] = array(
						'label' => $__templater->func('prefix_group', array('classifieds_listing', $__vars['groupId'], ), false),
						'_type' => 'optgroup',
						'options' => array(),
					);
					...
					if ($__templater->isTraversable($__vars['prefixesGrouped'][$__vars['groupId']])) {
						foreach ($__vars['prefixesGrouped'][$__vars['groupId']] AS $__vars['prefixId'] => $__vars['prefix']) {
							$__compilerTemp1[$__compilerTemp2]['options'][] = array(
								...
								'label' => $__templater->func('prefix_title', array('classifieds_listing', $__vars['prefixId'], ), true),
								'_type' => 'option',
							);
						}
					}

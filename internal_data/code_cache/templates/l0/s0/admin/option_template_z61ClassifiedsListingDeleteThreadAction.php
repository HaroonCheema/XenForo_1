<?php
// FROM HASH: 13a9b725bcf09cd4cb73dcc2f77d8c9a
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="u-inputSpacer">
		...
		'label' => 'Update thread title on listing deletion' . $__vars['xf']['language']['label_separator'],
	...
	array(
		...
		'label' => 'Automatically post in the listing thread on listing deletion',
		'hint' => 'If selected, a post will be made automatically on the creator\'s behalf explaining that the listing is no longer available.',
		'_type' => 'option',
	))) . '
	</div>
', array(

...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		'name' => 'user_criteria[listing_count][rule]',
		'value' => 'listing_count',
		'selected' => $__vars['criteria']['listing_count'],
		'label' => 'User has submitted at least X classifieds listings' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
		'name' => 'user_criteria[listing_count][data][listings]',
		'value' => $__vars['criteria']['listing_count']['listings'],
		'size' => '5',
		'min' => '0',
		'step' => '1',
	))),
	...
	array(
		'name' => 'user_criteria[feedback_count][rule]',
		'value' => 'feedback_count',
		'selected' => $__vars['criteria']['feedback_count'],
		'label' => 'User has at least X classifieds feedback' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
		'name' => 'user_criteria[feedback_count][data][feedback]',
		'value' => $__vars['criteria']['feedback_count']['feedback'],
		'size' => '5',
		'min' => '0',
		'step' => '1',
	))),

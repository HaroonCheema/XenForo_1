<?php
// FROM HASH: 85f03c61178e7a6359d0345134919f97
return array(
...
';
	if ($__templater->method($__vars['forum'], 'isUpdate', array())) {
		...
		if ($__vars['canChangeForumType']) {
			...
			' . $__templater->button('Change type', array(
				'href' => $__templater->func('link', array('molly/change-type', $__vars['node'], ), false),
				'overlay' => 'true',
			), '', array(
			)) . '
		';
	...
	<div class="buttonGroup">
		...
		' . $__templater->button('', array(
			'href' => $__templater->func('link', array('molly/delete', $__vars['node'], ), false),
			'icon' => 'delete',
			'overlay' => 'true',
		), '', array(
		)) . '
...
', array(
		'action' => $__templater->func('link', array('molly/save', $__vars['node'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
